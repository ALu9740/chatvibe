...
async function handleSendCode() {
  ...
  loading.value = true
  try {
    await sendCode({ email: email.value, scene: 'reset' })
...
async function handleVerify() {
  ...
  try {
    ...
    console.error('[ForgotPasswordView.handleVerify] 校验失败:', e)
  } finally {
    loading.value = false
  }
}
  ...
  <div class="auth-page">
    ...
    <div class="auth-card">
      ...
      <div class="auth-brand">
        ...
        <div class="tagline">找回密码，重新开启智能沟通之旅</div>
      </div>
      ...
      <div class="auth-footer">
        想起密码了？<el-link type="primary" :underline="false" @click="goLogin">返回登录</el-link>
      </div>
    </div>
  </div>
</template>
